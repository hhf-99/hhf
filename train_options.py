...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--n_epoch', type=int, default=150, help='total epoch for training')
        ...
        #####
        self._parser.add_argument('--is_train', type=bool, default=True, help="is_train")
        ####
        # self.is_train = True